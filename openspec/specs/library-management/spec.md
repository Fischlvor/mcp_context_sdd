...
Manages the lifecycle of technical libraries and their versioned document sets. Covers library CRUD with semantic search, semver-validated multi-version management, zero-downtime version refresh via batch_version atomic swap, and GitHub Release auto-import.
