...
Provides authentication and authorization for the management interface and MCP API calls. Supports enterprise SSO OAuth 2.0 login with short-lived AccessTokens and long-lived RefreshTokens, as well as long-term API Keys for MCP clients.
