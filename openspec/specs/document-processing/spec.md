...
Handles the full document ingestion pipeline: Markdown preprocessing, semantic chunking by heading hierarchy, chunk type detection, LLM enrichment for code chunks, embedding generation with Redis caching, content-hash deduplication, and SSE progress streaming.
